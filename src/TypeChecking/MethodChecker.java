...
public class MethodChecker {
    ...
    public LocalOrFieldVar check(LocalOrFieldVar parameter) throws Exception {
        ...
        switch (parameterName) {//todo: fix strings (not currently implemented as type)
            case "String" -> /*parameter.setType(AType.nonexistantapparently)*/
            ...
            default ->
                    throw new Exception();//todo: if object type implemented also check here, this is what name is needed for
        }
        return parameter;
    }
}